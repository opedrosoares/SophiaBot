...
# Limite de contexto para o LLM (reduzido para evitar erros)
MAX_CONTEXT_LENGTH = int(os.getenv('MAX_CONTEXT_LENGTH', '7000'))
...
# Caminho para o arquivo de dados (atualizado para nova estrutura)
DATA_PATH = BASE_DIR.parent / 'shared' / 'data' / 'normas_antaq_completo.parquet'

# Diretório para exports (atualizado para nova estrutura)
EXPORT_DIR = BASE_DIR.parent / 'shared' / 'exports'

# Diretório para logs (atualizado para nova estrutura)
LOG_DIR = BASE_DIR.parent / 'shared' / 'logs'
...
def validate_config():
    ...
    valid_models = ['gpt-4', 'gpt-3.5-turbo', 'gpt-4-turbo', 'gpt-4o', 'gpt-4o-mini', 'gpt-4.1-nano']
